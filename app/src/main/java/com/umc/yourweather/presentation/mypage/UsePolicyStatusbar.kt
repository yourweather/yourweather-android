...
class UsePolicyStatusbar : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_use_policy_statusbar)
        val toolbar: Toolbar = findViewById(R.id.tb_use_policy_back)
